...
const selectFont = require("./selectFont.js");
...
function generateLogo(answers) {
  ...
  // Obtains font SVG code for the SVG file.
  const fontSVG = selectFont(font);
  ...
  // This will create a template svg file code. We will pass in our shapes code, text color, text, and selected font and font code to generate our desired logo.
  const templateSVG = createSVG({
    shapeSVG,
    finalTextColor,
    text,
    font,
