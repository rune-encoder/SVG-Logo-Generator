...
// Constructor class Shape creates objects containing properties of our response.
// Master class - Other shape classes will inherit this class.
class Shape {
  // Passes our chosen text, text color, logo shape, and logo color.
  constructor(text, textColor, logoShape, logoColor) {
    this.text = text;
    this.textColor = textColor;
    this.logoShape = logoShape;
    this.logoColor = logoColor;
    // These properties use the selectHex function that will obtain the hex code from our chosen color.
    // Hexadecimal numbers for text and logo color is then saved in these two properties.
    this.hexText = selectHex(textColor);
    this.hexLogo = selectHex(logoColor);
  }
}

// From here and below all classes inherit from Shape class.
class Circle extends Shape {
  ...
  // Render function creates code from our selected shape that will be used in the final template.
  render() {
...
class Hexagon extends Shape {
  ...
  render() {
    return `<path d="M 149.931 17.671 L 229.2 58.881 L 229.2 141.302 L 149.931 182.513 L 70.662 141.303 L 70.662 58.881 Z" style="fill: ${this.hexLogo}" shape="n-gon 149.931 100.092 91.532 82.421 6 0 1@63f98990"></path>`;
  }
}
...
class Star extends Shape {
  ...
  render() {
    return `<path d="M 150.259 11.444 L 175.195 77.53 L 251.129 78.956 L 190.607 121.225 L 212.6 188.192 L 150.259 148.23 L 87.918 188.192 L 109.911 121.225 L 49.389 78.956 L 125.323 77.53 Z" style="fill: ${this.hexLogo}" shape="star 150.259 109.148 106.061 97.704 0.4 5 1@00c391ac"></path>`;
  }
}
...
class Moon extends Shape {
  ...
  render() {
    return `<path style="fill: ${this.hexLogo};" transform="matrix(0.317274, 0, 0, 0.24623, -63.813007, -36.903751)" d="M 369.571 392 A 370 370 0 1 1 369.571 762 A 270.746 270.746 0 1 0 369.571 392 Z" shape="crescent 690 577 370 300 0.7 1@fdacdeae"></path>`;
  }
}
...
class Witch extends Shape {
  ...
  render() {
    ...
    <path style="fill: ${this.hexLogo}; stroke: rgb(0, 0, 0); transform-box: fill-box; transform-origin: 50% 50%;" transform="matrix(0.306554, -0.007664, 0.006844, 0.273799, -1307.453003, -333.67807)" d="M 1163.814 326 A 230 230 0 1 1 1163.814 556 A 168.302 168.302 0 1 0 1163.814 326 Z" shape="crescent 1363 441 230 300 0.7 1@871811df"></path>
