...
describe("Shape", () => {
  ...
  describe("Hexagon", () => {
    it("Should render the `selected color` with the correct hexadecimal code for our Hexagon SVG file code.", () => {
      ...
      shape.hexLogo = colorHex;
      expect(shape.render()).toEqual(
        `<path d="M 149.931 17.671 L 229.2 58.881 L 229.2 141.302 L 149.931 182.513 L 70.662 141.303 L 70.662 58.881 Z" style="fill: #E5AA70" bx:shape="n-gon 149.931 100.092 91.532 82.421 6 0 1@63f98990"></path>`
      );
    });
  });
  ...
  describe("Star", () => {
    it("Should render the `selected color` with the correct hexadecimal code for our Triangle SVG file code.", () => {
      ...
      shape.hexLogo = colorHex;
      expect(shape.render()).toEqual(
        `<path d="M 150.259 11.444 L 175.195 77.53 L 251.129 78.956 L 190.607 121.225 L 212.6 188.192 L 150.259 148.23 L 87.918 188.192 L 109.911 121.225 L 49.389 78.956 L 125.323 77.53 Z" style="fill: #E5E4E2" bx:shape="star 150.259 109.148 106.061 97.704 0.4 5 1@00c391ac"></path>`
      );
    });
  });
  ...
  describe("Moon", () => {
    it("Should render the `selected color` with the correct hexadecimal code for our Triangle SVG file code.", () => {
      ...
      shape.hexLogo = colorHex;
      expect(shape.render()).toEqual(
        `<path style="fill: #96DED1;" transform="matrix(0.317274, 0, 0, 0.24623, -63.813007, -36.903751)" d="M 369.571 392 A 370 370 0 1 1 369.571 762 A 270.746 270.746 0 1 0 369.571 392 Z" bx:shape="crescent 690 577 370 300 0.7 1@fdacdeae"></path>`
      );
    });
  });
  ...
  describe("Witch", () => {
    it("Should render the `selected colors` with the correct hexadecimal code for our Triangle SVG file code.", () => {
    ...
    <path style="fill: #353935; stroke: rgb(0, 0, 0); transform-box: fill-box; transform-origin: 50% 50%;" transform="matrix(0.306554, -0.007664, 0.006844, 0.273799, -1307.453003, -333.67807)" d="M 1163.814 326 A 230 230 0 1 1 1163.814 556 A 168.302 168.302 0 1 0 1163.814 326 Z" bx:shape="crescent 1363 441 230 300 0.7 1@871811df"></path>
